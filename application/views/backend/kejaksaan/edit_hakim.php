        ...
        <div class="col-lg-6 ml-auto mr-auto">
            ...
            <div class="card card-stats  card-round">
                <div class="card-body">
                    ...
                    <form action="<?php echo base_url() ?>Backend/kejaksaan/update_hakim/<?php echo $hakim->id_hakim ?>" method="post">
                        ...
                        <a href="<?php echo base_url() ?>Backend/kejaksaan/hakim" class="btn btn-danger">Kembali</a>
