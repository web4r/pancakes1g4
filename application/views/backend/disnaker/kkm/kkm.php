                ...
                <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <form action="<?php echo base_url() ?>Backend/disnaker/save_kkm" method="post">
                            ...
                            <tbody>
                                ...
                                foreach ($kkm as $data) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url('Backend/disnaker/edit_kkm/' . $data->id_kkm) ?>" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Edit">
                                                <i class="fa fa-edit"></i>
                                            </a>

                                            <a href="<?php echo base_url('Backend/disnaker/delete_kkm/' . $data->id_kkm) ?>" class="btn btn-link btn-danger" data-original-title="Remove" data-toggle="tooltip">
