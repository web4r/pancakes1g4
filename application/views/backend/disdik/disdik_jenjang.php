<div class="panel-header bg-primary-gradient">
    <div class="page-inner py-5">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
            <div>
                <h2 class="text-white pb-2 fw-bold">Angka Putus Sekolah Menurut Jenjang Pendidikan SD, SLTP Dan SLTA</h2>
            </div>
                ...
                <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <form action="<?php echo base_url() ?>Backend/disdik/save_disdik_jenjang" method="post">
                                    ...
                                    <div class="form-group form-group-default">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-6 col-sm-6">
                                                <div class="form-group form-group-default">
                                                    <label>L</label>
                                                    <input name="sd_l" type="number" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-xs-6 col-sm-6">
                                                <div class="form-group form-group-default">
                                                    <label>P</label>
                                                    <input name="sd_p" type="number" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group form-group-default">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-6 col-sm-6">
                                                <div class="form-group form-group-default">
                                                    <label>L</label>
                                                    <input name="sltp_l" type="number" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-xs-6 col-sm-6">
                                                <div class="form-group form-group-default">
                                                    <label>P</label>
                                                    <input name="sltp_p" type="number" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <tbody>
                                <?php foreach ($disdik_jenjang as $item) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url('Backend/disdik/edit_disdik_jenjang/' . $item->id_disdik_jenjang) ?>" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Edit">
                                                <i class="fa fa-edit"></i>
                                            </a>

                                            <a href="<?php echo base_url('Backend/disdik/delete_disdik_jenjang/' . $item->id_disdik_jenjang) ?>" class="btn btn-link btn-danger" data-original-title="Remove" data-toggle="tooltip">
